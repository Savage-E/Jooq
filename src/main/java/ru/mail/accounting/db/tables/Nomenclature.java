...
public class Nomenclature extends TableImpl<NomenclatureRecord> {
     ...
     */
    public final TableField<NomenclatureRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(30), this, "");

    /**
     * The column <code>public.nomenclature.internal_code</code>.
     */
    public final TableField<NomenclatureRecord, Long> INTERNAL_CODE = createField(DSL.name("internal_code"), SQLDataType.BIGINT, this, "");
    ...
    public List<UniqueKey<NomenclatureRecord>> getKeys() {
        return Arrays.<UniqueKey<NomenclatureRecord>>asList(Keys.ID_PKEY);
    }
